    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to', models.ForeignKey(related_name='+', verbose_name='to', to='contenttypes.ContentType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('through', models.ForeignKey(related_name='+', blank=True, to='contenttypes.ContentType', help_text='Intermediary model', null=True)),
                ('to', models.ForeignKey(related_name='+', verbose_name='to', to='contenttypes.ContentType')),
            ],
            options={
