...
from mutant.contrib.related.models import RelatedFieldDefinition
from mutant.db.fields import PythonObjectReferenceField
...
class ImportablePythonObjectFieldTest(BaseModelDefinitionTestCase):
    ...
    def test_allow_string_object_path(self):
        string_object_path = '.'.join(('mutant.contrib.related.models',
    ...
    def test_allow_tuple_object_path(self):
        tuple_object_path = ('mutant.contrib.related.models',
                             'RelatedFieldDefinition')
        self.assertEqual(RelatedFieldDefinition,
    ...
    def test_import_failures(self):
        ...
        self.assertRaisesMessage(ImportError,
                                 'Cannot import name null from mutant',
                                 self.base_field.to_python, 'mutant.null')
